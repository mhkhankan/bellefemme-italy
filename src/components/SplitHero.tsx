...
export const SplitHero = () => {
  return (
    <section id="top" className="relative" style={{ minHeight: '100svh' }}>
      <div className="grid md:grid-cols-2 h-full" style={{ minHeight: '100svh' }}>
        {/* Left — Atelier */}
        <div id="atelier" className="relative flex flex-col items-center justify-center px-8 md:px-16 py-32 border-b md:border-b-0 md:border-r border-primary/10">
          <motion.div
          ...
          >
            ...
            <h2 className="font-cormorant text-4xl md:text-5xl lg:text-6xl font-light text-foreground leading-[1.1] tracking-wide">
              Permanent<br />
        ...
        {/* Right — Academy */}
        <div id="academy" className="relative flex flex-col items-center justify-center px-8 md:px-16 py-32">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
          <motion.div
            ...
            className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-primary/30 flex items-center justify-center bg-background/90 backdrop-blur-sm"
          >
            <span className="font-cormorant text-2xl md:text-3xl font-semibold text-primary tracking-wider">BF</span>
          </motion.div>
        </div>
      </div>
