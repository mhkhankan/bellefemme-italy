...
export const WhatsAppSticky = () => {
  return (
    <a
      ...
      className="fixed right-6 bottom-6 z-50 flex items-center gap-3 group border border-primary/30 bg-background/90 backdrop-blur-sm px-5 py-3.5 min-h-[44px] hover:bg-primary hover:border-primary transition-all duration-500"
    >
