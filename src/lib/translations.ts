...
export const translations = {
  it: {
    ...
    treatments: {
      ...
      items: [
        { number: '01', id: 'raw-stroke', title: 'RAW STROKE', subtitle: 'Iperrealismo Strutturale', description: 'Microblading permanente a Varese con metodologia PhiBrows — ogni tratto segue la direzione naturale del pelo. Tecnica blade-stroke calibrata su anatomia facciale e struttura ossea. Sopracciglia permanenti naturali e impercettibili, semplicemente tue.' },
        ...
        { number: '04', id: 'pigment-restauro', title: 'PIGMENT RESTAURO', subtitle: 'Laboratorio Correttivo', description: 'Correzione PMU a Varese per sopracciglia virate al grigio, arancio o rosso — protocolli avanzati di neutralizzazione. Rimozione pigmenti compromessi per preparare la pelle a nuova progettazione armoniosa. Il passato azzerato. Il tuo viso, riprogettato.' },
        { number: '05', id: 'lip-vitality', title: 'NUDE-LIP INFUSION', subtitle: 'Vitalità Labiale Anatomica', description: 'Trucco permanente labbra a Varese — colore, profilo e simmetria ridefiniti con dermopigmentazione sfumata. Neutralizza labbra scure o irregolari con finish naturale effetto acquerello. Labbra permanenti naturali che sembrano più belle non truccate.' },
